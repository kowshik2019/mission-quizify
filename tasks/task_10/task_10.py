    ...
    #     st.session_state['question_index'] = 0
        ...
        with st.container():
            ...
            with st.form("MCQ"):
                ...
                st.form_submit_button("Next Answer", on_click=lambda: quiz_manager.next_question_index(direction=1))
                st.form_submit_button("Previous Answer", on_click=lambda: quiz_manager.next_question_index(direction=-1))